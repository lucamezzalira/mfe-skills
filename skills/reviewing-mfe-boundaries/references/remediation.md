...
**If the boundary is ambiguous**: run the boundary health check from `understanding-mfe-architecture/references/rules.md`. If it fails two or more tests, it is in the wrong category.
