# MFE boundary rules — critical (rules 3 and 4)
...
Critical rules: hide implementation details; communicate via events not shared state.
For rules 1, 2, 5–8 and governance extensions: load `references/rules-core-standard.md`.
For framework-specific patterns: load `references/rules-toolchain.md`.
